    ...
    <div class="diy-wrapper">
      ...
      <div>
        ...
        <div class="flex" id="quantity">
          <h4>Quantity DIY:</h4>
          <input type="text" class="input-small" value="1" id="diysAmount">
      ...
      <DIYPizza v-for="diy in this.diys" :key="diy.id"/>
...
<script>
// @ is an alias to /src
import DIYPizza from '@/components/DIYPizza.vue'
  ...
  methods: {
    add: function() {
      let diy = {
        ...
        side2: "Fries",
        id: (this.diys.length + 1)
      };
      this.diys.push(diy);
      document.getElementById('diysAmount').value = Number(document.getElementById('diysAmount').value) + 1;
    },

    subtract: function() {
      if(document.getElementById('diysAmount').value > 1) {
        this.diys.pop();
        document.getElementById('diysAmount').value = document.getElementById('diysAmount').value - 1;
      }
    },
